...
-- У плані виконання це може призвести до Index Scan або Table Scan.
-- Scan означає, що сервер переглядає багато рядків, а Seek означає, що сервер одразу знаходить потрібний діапазон в індексі.
